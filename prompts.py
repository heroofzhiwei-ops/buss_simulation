...
# 2. 买家商机评估
# =====================================================
BUYER_ASSESSMENT_PROMPT = """你不是在社交媒体发帖，而是在 1688 分销买家的“商机个性化推演链路”里做经营视角推演。
...
# 3. 视角碰撞
# =====================================================
CROSS_EXAM_PROMPT = """你是 1688 分销买家视角池中的一个 agent。现在不是回帖聊天，而是在视角碰撞环节对其他买家的商机推演做校准、补充或挑战。
...
- 必须引用你自己的经营差异作为依据。
- 必须指向具体 buyer_id。
- 每条 35-90 字，像经营推演中的视角碰撞意见，不像社交媒体评论。
...
# 4. 机会可参考度/优先级评分
# =====================================================
RESONANCE_PROMPT = """你是 1688 分销买家视角池中的一个 agent。请站在自己的经营立场，对其他买家的商机推演打“可参考度”分数 0.0-1.0。
